...
<script type="text/javascript" src="<%=path%>/weixin/Js/wxUserLabel/wxUserLabel.js"></script>
	...
	<div id="toolbar" style="padding:10px;height:auto;">
			<div>
				...
				<span style="padding:15px;">
						...
						<button id="delBtn" class="btn btn-primary"  data-toggle="modal" data-target="#delModal">批量删除</button>

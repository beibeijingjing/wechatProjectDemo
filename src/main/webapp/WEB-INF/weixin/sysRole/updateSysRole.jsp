...
<script type="text/javascript">
  		...
  		var sessionId='<%=sessionId%>';
  		 ...
  		 function submitData(){
   			$.ajax({
 	    			type : "POST",
 	    			url : basePath + "/pc/updateSysRole.do",
 	    			data : {
 	    				"id":$('#id').val(),
 	...
 	<form action="" method="post" class="definewidth m20">
 		...
 		<table class="table table-bordered table-hover m10">
 			<tr>
 				...
 				<td>
 				  <input type="text" name="roleName" id="roleName" value="${role.role_name }"/>
 				</td>
 			</tr>
 			<tr>
 				<td width="10%" class="tableleft">角色编码</td>
 				<td>
 				  <input type="text" name="roleCode" id="roleCode" value="${role.role_code }"/>
 				</td>
 			</tr>
 			<tr>

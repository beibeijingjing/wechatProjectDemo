   ...
   function doSearch() {
            ...
            $('#cusTable').bootstrapTable({
                url: basePath+'/pc/getWxMenuList.do',         //请求后台的URL（*）
                method: 'get',                      //请求方式（*）
    ...
    function toUpdate(id) {
    	window.location.href=basePath + "/pc/toGetUpdateWxMenu.do?id="+id;
    }

    function toAdd() {
    	window.location.href=basePath + "/pc/toGetAddWxMenu.do";
    }
    ...
    function toUpdateStatus() {
    	...
    	if(flag==0){
    		...
    		$.ajax({
    			type : "POST",
    			url : basePath + "/pc/updateWxMenuStatus.do",
    			data : {
    				"id" : id,
    				"status" : status
    			},

   ...
   function doSearch() {
            ...
            $('#cusTable').bootstrapTable({
                url: basePath+'/pc/getSysMenuList.do',         //请求后台的URL（*）
                method: 'get',                      //请求方式（*）
    ...
    function toUpdate(id) {
    	window.location.href=basePath + "/pc/toGetUpdateSysMenu.do?id="+id;
    }

    function toAdd() {
    	window.location.href=basePath + "/pc/toGetAddSysMenu.do";
    }
    ...
    function toUpdateStatus() {
    	...
    	if(flag==0){
    		...
    		$.ajax({
    			type : "POST",
    			url : basePath + "/pc/updateSysMenuStatus.do",
    			data : {
    				"id" : id,
    				"status" : status
    			},

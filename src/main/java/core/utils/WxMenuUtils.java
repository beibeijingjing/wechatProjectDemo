...
public class WxMenuUtils {
	 ...
	 * @throws
	 */
	public static String createMenu() throws WxBaseException {
		// String menu =
		...
		try {
			...
			System.out
					.println("||||||||||||||||||||||||||||||||||||||||||||||||||||||");
			System.out.println("=========================message:创建菜单结果："
					+ message + "=======================");
			System.out
					.println("||||||||||||||||||||||||||||||||||||||||||||||||||||||");
			return "返回信息" + message;
	 ...
	 * @throws
	 */
	public static String deleteMenu() throws WxBaseException {
		WxAuthService authService = new WxAuthService();
		WxAuth wxAuth = authService.getAccessToken(WxConfig.APP_ID,
				WxConfig.APP_SECRET);
		if (wxAuth == null) {
		...
		try {
			...
			System.out.println("=========================deleteMenu返回信息:"
					+ message + "=========================");
			System.out.println("=========================deleteMenu返回信息:"
					+ message + "=========================");
	...
	public static void main(String[] args) {
		...
		/*
		 * try { WxMenuUtils.deleteMenu(); } catch (WxException e) {
		 * e.printStackTrace(); }
		 */

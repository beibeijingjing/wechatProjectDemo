...
/*
@Override
public void createBlog(Blog blog, String userId) {
blog.setId(null);
...
System.out.println(blog.toString() + "  " + userId);
System.out.println(blog.toString() + "  " + userId);
 ...
 */
/*
 * @Override public List<BlogDetails> getUserBlogList(String userId) { return
 * blogMapper.getUserBlogDetails(userId); }
 * 
 * }
 */
 ...
 * @ResponseBody
 * 
 * @RequestMapping(value="/getBlogDetails",method=RequestMethod.POST) public
 * AjaxResult getBlogDetails(Integer blogId){ Blog blog=
 * blogService.selectByPrimaryKey(blogId); return AjaxResult.getOK(blog); } }
 */
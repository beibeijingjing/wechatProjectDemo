...
public interface UserRoleMapper extends IBaseMapper<UserRole> {
	...
	//批量增加
	public void addUserRoleList(@Param("userId")String userId,@Param("roleIdList")List<Integer> roleIdList);
	//批量删除
	public void deleteUserRoleList(@Param("userId")String userId,@Param("roleIdList")List<Integer> roleIdList);
	//批量删除
